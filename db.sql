...
GROUP BY
 ...
 -- to retrieve the total number of trips taken by each user, along with their name and contact
number
 SELECT
...
GROUP BY
 ...
 -- retrieves the total number of trips taken by each taxi, along with its registration number and
model:
 SELECT
